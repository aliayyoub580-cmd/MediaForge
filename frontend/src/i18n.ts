  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        subtitle: 'Download HD videos and audio from TikTok, Instagram & Facebook. No watermarks. No signup.',
      ...
      platforms: { title: 'Supported Platforms', subtitle: 'Works with popular social platforms' },
      features: {
      ...
      errors: {
        ...
        youtube_unavailable: 'YouTube downloads are not available yet.',
  ...
  es: {
    translation: {
      hero: {
        ...
        subtitle: 'Descarga videos HD y audio de TikTok, Instagram y Facebook.',
  ...
  ar: {
    translation: {
      hero: {
        ...
        subtitle: 'تحميل مقاطع الفيديو والصوت بجودة عالية من TikTok وInstagram وFacebook.',
